...
//
// CRI 'downward' dummy interface for NRI
//
...
func (*nriAPI) WithPodSandboxStop(*sstore.Sandbox) containerd.ProcessDeleteOpts {
	return func(_ context.Context, _ containerd.Process) error {
		return nil
	}
}

func (*nriAPI) WithContainerStop(*cstore.Container) containerd.ProcessDeleteOpts {
	return func(_ context.Context, _ containerd.Process) error {
		return nil
	}
}
...
//
// CRI 'upward' dummy interface for NRI
//
