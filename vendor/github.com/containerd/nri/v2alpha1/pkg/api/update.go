...
func (u *ContainerUpdate) DisableLinuxMemoryOOMKiller() {
	u.initLinuxResourcesMemory()
...
func (u *ContainerUpdate) UseLinuxMemoryHierarchy() {
	u.initLinuxResourcesMemory()
...
func (u *ContainerUpdate) SetLinuxCPURTPeriod(value uint64) {
	u.initLinuxResourcesCPU()
