...
// DisableLinuxMemoryOOMKiller records disabling the OOM killer for a container.
func (a *ContainerAdjustment) DisableLinuxMemoryOOMKiller() {
	a.initLinuxResourcesMemory()
	a.Linux.Resources.Memory.DisableOomKiller = Bool(true)
}

// UseLinuxMemoryHierarchy records enabling hierarchical memory accounting for a container.
func (a *ContainerAdjustment) UseLinuxMemoryHierarchy() {
	a.initLinuxResourcesMemory()
...
func (a *ContainerAdjustment) SetLinuxCPURTRuntime(value int64) {
	a.initLinuxResourcesCPU()
...
func (a *ContainerAdjustment) SetLinuxCPURTPeriod(value uint64) {
	a.initLinuxResourcesCPU()
