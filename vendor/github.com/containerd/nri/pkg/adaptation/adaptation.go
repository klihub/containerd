...
func WithBuiltinPlugins(plugins ...*BuiltinPlugin) Option {
	return func(r *Adaptation) error {
...
func WithDefaultValidator(cfg *DefaultValidatorConfig) Option {
	return func(r *Adaptation) error {
		if plugin := GetDefaultValidator(cfg); plugin != nil {
			r.builtin = append([]*BuiltinPlugin{plugin}, r.builtin...)
		}
		return nil
	}
}
