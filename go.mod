...
replace github.com/containerd/ttrpc => github.com/klihub/ttrpc v0.0.0-20240821112027-65b53797300d

replace github.com/containerd/nri => github.com/klihub/nri v0.0.0-20240821140403-a2f98a8bbfb6
