...
require (
	...
	tags.cncf.io/container-device-interface/specs-go v1.0.1-0.20251114135136-1b24d969689f // indirect
)
...
replace github.com/containerd/nri => github.com/klihub/nri v0.0.0-20251117122010-c2faa3ddc3fc
